  ...
  const programs: Program[] = [
    {
      title: "Education Initiatives",
      imageUrl:
        "https://i.postimg.cc/LsVNQ2YF/children-education-donation-campaign.jpg",
      hoverText:
        "Empowering young minds through innovative learning programs and scholarships",
    },
    {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative h-52 w-full bg-gradient-to-br from-blue-50 to-white overflow-hidden"
      >
        {/* Floating elements */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')]"></div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <motion.div variants={fadeInRight} className="md:w-1/2">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our mission is to provide accessible education, preserve cultural
              heritage, and empower underprivileged communities.
            </p>
          </motion.div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {coreValues.map((value, index) => (
              <motion.div
                ...
                variants={
                  index % 2 === 0
                    ? slideInLeft(0.1 * index)
                    : slideInRight(0.1 * index)
                }
                initial="hidden"
                whileInView="show"
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.3 }}
          className="mb-20 bg-gradient-to-br from-blue-600 to-white overflow-hidden p-8 rounded-xl"
        >
          <motion.h2
            variants={fadeInUp}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            {programs.map((program, index) => (
              <motion.div
                key={index}
                variants={slideInBottom(0.1 * index)}
                initial="hidden"
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}
                className="relative h-80 w-full overflow-hidden rounded-xl shadow-lg group"
              >
                ...
                {/* Text Content */}
                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                  <motion.h3 className="text-2xl font-bold mb-2 transform transition-all duration-500 group-hover:-translate-y-3 group-hover:text-3xl">
                    {program.title}
                  </motion.h3>

                  <div className="opacity-0 max-h-0 overflow-hidden transition-all duration-700 group-hover:opacity-100 group-hover:max-h-40">
                    <p className="text-blue-100 mb-4">{program.hoverText}</p>
                    <button className="px-4 py-2 bg-white text-blue-800 rounded-lg font-medium hover:bg-blue-100 transition-colors">
                      Learn More
                    </button>
                  </div>
                </div>
